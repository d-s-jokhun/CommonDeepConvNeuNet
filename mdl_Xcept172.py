...
if UseExistingArchitectureCores:
    models['mdl_Xception_172'] = tf.keras.applications.Xception(include_top=False, weights="imagenet", input_shape=(172, 172, 3)) #input_shape=(71, 71, 3)
    keras_preprocess_layers['mdl_Xception_172'] = tf.keras.applications.xception.preprocess_input
